...
\theoremstyle{break}
\theoremseparator{}
\newtheorem*{progress}{\faTasks 实验进度}
\newtheorem{problem}{\faCheckSquareO 问题}
\newtheorem*{thinking}{\faCommentingO 思考}
\newtheorem*{myanswer}{\faEdit 答案}
\newtheorem*{feedback}{\faCommenting 反馈}
\newtheorem*{postscript}{\faCoffee 杂项}
